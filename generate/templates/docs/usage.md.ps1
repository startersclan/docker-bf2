...
docker run --rm startersclan/docker-bf2:$( $VARIANTS | ? { $_['tag_as_latest'] } | Select-Object -ExpandProperty tag | Sort-Object | Select-Object -First 1 ) cat /server/bf2/mods/bf2/esai/credits.txt
docker run --rm startersclan/docker-bf2:$( $VARIANTS | ? { $_['tag_as_latest'] } | Select-Object -ExpandProperty tag | Sort-Object | Select-Object -First 1 ) cat "/server/bf2/mods/bf2/esai/quick start.txt"
docker run --rm startersclan/docker-bf2:$( $VARIANTS | ? { $_['tag_as_latest'] } | Select-Object -ExpandProperty tag | Sort-Object | Select-Object -First 1 ) cat "/server/bf2/mods/bf2/esai/users guide.txt"
docker run --rm startersclan/docker-bf2:$( $VARIANTS | ? { $_['tag_as_latest'] } | Select-Object -ExpandProperty tag | Sort-Object | Select-Object -First 1 ) cat /server/bf2/mods/bf2/esai/version.txt
